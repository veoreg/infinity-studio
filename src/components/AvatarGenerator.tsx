                                ...
                                <div className="absolute inset-0 z-10 group cursor-pointer">
                                    ...
                                    <div className="w-full h-full relative">
                                        {originalImageUrl && generatedImage ? (
                                            <ImageComparisonSlider before={originalImageUrl} after={generatedImage} />
                                        ) : (
                                            <img
                                                    ...
                                                    <div className="flex flex-col md:flex-row gap-3 md:gap-4 items-stretch md:items-center w-full">
                                                        ...
                                                        <div className="flex gap-2 shrink-0 justify-end">
                                                            <button
                                                                ...
                                                                className="flex-1 md:flex-none px-4 md:px-6 py-2 bg-gold-gradient text-black font-black uppercase tracking-widest text-[9px] md:text-[10px] rounded-xl hover:shadow-[0_0_20px_rgba(210,172,71,0.4)] hover:scale-105 active:scale-95 transition-all disabled:opacity-50 disabled:grayscale flex items-center justify-center gap-2 whitespace-nowrap"
                                                            >
