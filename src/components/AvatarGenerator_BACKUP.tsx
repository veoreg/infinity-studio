...
const CustomSelect: React.FC<CustomSelectProps> = ({ label, value, onChange, options }) => {
    ...
    return (
        <div className="relative group" ref={dropdownRef}>
            ...
            <div
                className={`w-full bg-[#0a0a0a] border ${isOpen ? 'border-[#d2ac47]' : 'border-[#d2ac47]/30'} text-[#F9F1D8] p-2 cursor-pointer flex justify-between items-center transition-all hover:border-[#d2ac47]/60`}
            ...
            {isOpen && (
                <div className="absolute top-full left-0 w-full bg-[#050505] border border-[#d2ac47] z-[100] shadow-[0_10px_40px_rgba(0,0,0,0.9)] animate-fade-in-down mt-1">
                    {options.map((opt) => (
                        <div
                            key={opt.value}
        ...
        <div className="w-full relative animate-fade-in pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-8 space-y-8 relative z-10">
                    ...
                    <div className="bg-[#121212] border-art-deco p-8 relative shadow-[0_0_50px_rgba(0,0,0,0.8)] group">
                        <div className="absolute top-0 left-0 px-4 py-1 bg-[#d2ac47] text-black text-[10px] font-bold tracking-[0.2em] uppercase">
                            Identity Matrix
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <input type="number" value={age} onChange={(e) => setAge(Number(e.target.value))}
                                    className="w-full bg-[#0a0a0a] border border-[#d2ac47]/30 text-[#F9F1D8] p-3 focus:outline-none focus:border-[#d2ac47] rounded-none" />
                            </div>
                            <div className="space-y-2">
                                <CustomSelect
                                    label="Nationality"
                    ...
                    <div className="bg-[#121212] border-art-deco p-8 relative shadow-[0_0_50px_rgba(0,0,0,0.8)]">
                        <div className="absolute top-0 left-0 px-4 py-1 bg-[#d2ac47] text-black text-[10px] font-bold tracking-[0.2em] uppercase">
                            Visual Source
                        </div>
                        ...
                        <div className="space-y-6 mt-6">
                            ...
                            <div className="group">
                                ...
                                <div className="flex gap-2 relative">
                                    <input type="url" value={faceImageUrl} onChange={(e) => setFaceImageUrl(e.target.value)}
                                        placeholder="https://..."
                                        className="w-full bg-[#0a0a0a] border border-[#d2ac47]/30 text-[#F9F1D8] p-4 focus:outline-none focus:border-[#d2ac47] rounded-none transition-all focus:shadow-[0_0_20px_rgba(210,172,71,0.1)]" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className={`border p-6 transition-all duration-300 group/body ${grabBody ? 'border-[#d2ac47] bg-[#0a0a0a]' : 'border-[#d2ac47]/20 bg-transparent hover:border-[#d2ac47]/40'} `}>
                                    <div className="flex items-center gap-3 mb-4 cursor-pointer" onClick={() => setGrabBody(!grabBody)}>
                                        <button
                                            className={`w-8 h-8 border flex items-center justify-center transition-all ${grabBody ? 'border-[#d2ac47] text-[#d2ac47] bg-[#d2ac47]/10' : 'border-[#d2ac47]/30 text-[#d2ac47]/50 hover:text-[#d2ac47] hover:border-[#d2ac47]'} `}>
                                            <Camera size={16} />
                                        </button>
                                    ...
                                    {grabBody && (
                                        <div className="animate-fade-in">
                                            <input type="url" value={bodyRefUrl} onChange={(e) => setBodyRefUrl(e.target.value)}
                                                ...
                                                className="w-full bg-[#080808] border border-[#d2ac47]/30 text-[#F9F1D8] p-3 text-xs focus:outline-none focus:border-[#d2ac47]" />
                                        </div>
                                    )}
                                </div>

                                {/* Composition Reference Toggle */}
                                <div className={`border p-6 transition-all duration-300 group/comp ${grabComposition ? 'border-[#d2ac47] bg-[#0a0a0a]' : 'border-[#d2ac47]/20 bg-transparent hover:border-[#d2ac47]/40'} `}>
                                    <div className="flex items-center gap-3 mb-4 cursor-pointer" onClick={() => setGrabComposition(!grabComposition)}>
                                        <button
                                            className={`w-8 h-8 border flex items-center justify-center transition-all ${grabComposition ? 'border-[#d2ac47] text-[#d2ac47] bg-[#d2ac47]/10' : 'border-[#d2ac47]/30 text-[#d2ac47]/50 hover:text-[#d2ac47] hover:border-[#d2ac47]'} `}>
                                            <Layers size={16} />
                                        </button>
                        ...
                        <div className="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="range" min="0" max="1" step="0.05" value={instantIdWeight} onChange={(e) => setInstantIdWeight(Number(e.target.value))}
                                    className="w-full h-1 bg-[#d2ac47]/20 rounded-none appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-[#d2ac47]" />
                            </div>

                            <div>
                                <label className="text-[#d2ac47] text-[10px] font-bold tracking-[0.2em] uppercase mb-2 block">Prompt Details</label>
                                <textarea value={userPrompt} onChange={(e) => setUserPrompt(e.target.value)}
                                    className="w-full bg-[#0a0a0a] border border-[#d2ac47]/30 text-[#F9F1D8] p-3 text-sm h-24 focus:outline-none focus:border-[#d2ac47] rounded-none shadow-inner"
                                    placeholder="Describe specific details..." />
                                {/* Advanced Controls: Seed & Raw Mode */}
                                <div className="flex items-center gap-4 mt-3">
                                    {/* Seed Control */}
                                    <div className="flex-1 flex items-center gap-2 bg-[#0a0a0a] border border-[#d2ac47]/20 p-1 px-2">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-3 py-1.5 border transition-all ${rawPromptMode ? 'bg-[#d2ac47] border-[#d2ac47] text-black' : 'bg-transparent border-[#d2ac47]/30 text-[#d2ac47]/60 hover:text-[#d2ac47] hover:border-[#d2ac47]'}`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-3 py-1.5 border transition-all ${upscale ? 'bg-[#d2ac47] border-[#d2ac47] text-black' : 'bg-transparent border-[#d2ac47]/30 text-[#d2ac47]/60 hover:text-[#d2ac47] hover:border-[#d2ac47]'}`}
                                    >
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full btn-gold py-6 text-sm tracking-[0.4em] font-bold uppercase flex items-center justify-center gap-4 transition-all hover:scale-[1.01] shadow-[0_0_30px_rgba(210,172,71,0.2)]"
                    >
                ...
                <div className="lg:col-span-4 sticky top-32 z-10 space-y-4">
                    ...
                    <div className="bg-[#050505] border-art-deco aspect-[9/16] relative flex items-center justify-center overflow-hidden shadow-2xl group flex-col min-h-[500px]">
                        ...
                        {generatedImage && (
                            <div className="absolute top-12 left-0 w-full z-30 flex justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <button
                                    onClick={handleGenerate}
                                    disabled={loading}
                                    className={`btn-gold px-6 py-3 text-xs tracking-widest uppercase flex items-center gap-2 border border-[#d2ac47]/50 hover:bg-[#d2ac47] hover:text-black shadow-[0_4px_10px_rgba(0,0,0,0.5)] ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                                >
                                    <RefreshCw size={16} className={loading ? "animate-spin" : ""} /> {loading ? "Processing..." : "Regenerate"}
                                </button>
                                <button onClick={handleDownload} className="btn-gold px-6 py-3 text-xs tracking-widest uppercase flex items-center gap-2 shadow-[0_4px_10px_rgba(0,0,0,0.5)]">
