...
const GenerationLogger = () => {
    ...
    React.useEffect(() => {
        const steps = [
            ...
            { msg: "K-Sampler: Denoising Latents (Start)...", delay: 50000 },
            { msg: "K-Sampler: Denoising Latents (30%)...", delay: 150000 },
            { msg: "K-Sampler: Denoising Latents (70%)...", delay: 280000 },
        ...
        <div className="w-full relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch min-h-[450px]">
                ...
                <div className="hidden xl:block lg:col-span-4">
                    <div className="h-full w-full relative overflow-hidden group border-art-deco shadow-2xl">
                        <div className="absolute inset-0 bg-[#080808]/20 z-10 mix-blend-overlay"></div>
                        {/* Art Deco Corners */}
                        <div className="absolute top-2 left-2 w-8 h-8 border-t-2 border-l-2 border-[#d2ac47] z-30"></div>
                        <div className="absolute top-2 right-2 w-8 h-8 border-t-2 border-r-2 border-[#d2ac47] z-30"></div>
                ...
                <div className="lg:col-span-12 xl:col-span-5 flex flex-col">
                    <div className="bg-velvet-depth border-art-deco p-4 relative overflow-hidden flex-1 flex flex-col justify-start shadow-2xl">
                        ...
                        <div className="space-y-4 relative z-10 mt-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 min-h-[250px]">
                                {/* Image Input Frame */}
                                <div className="group relative border border-[#d2ac47]/30 bg-[#0a0a0a] hover:border-[#d2ac47] transition-all duration-500 overflow-hidden flex flex-col">
                                    <div className="absolute top-0 left-0 bg-[#d2ac47] text-black text-[9px] font-bold px-3 py-1 uppercase tracking-[0.2em] z-20">
                                        Source Image
                                    </div>

                                    {/* Preview Area or Placeholder */}
                                    <div className="flex-1 relative flex items-center justify-center bg-[#050505] overflow-hidden group-hover:bg-black/50 transition-colors">
                                        {imageUrl ? (
                                            <>
                                                <div className="absolute inset-0 bg-cover bg-center opacity-30 blur-sm" style={{ backgroundImage: `url(${imageUrl})` }}></div>
                                                <img src={imageUrl} alt="Source" className="relative h-full w-full object-contain z-10 p-2" />
                                            </>
                                        ) : (
                                            <div className="text-[#d2ac47]/50 flex flex-col items-center gap-2 group-hover:scale-110 transition-transform duration-500">
                                                <ImageIcon size={48} strokeWidth={1} />
                                                <span className="text-[9px] tracking-[0.3em] uppercase">No Signal</span>
                                            </div>
                                        )}
                                    </div>
                                ...
                                {/* Prompt Input Frame */}
                                <div className="group relative border border-[#d2ac47]/30 bg-[#0a0a0a] hover:border-[#d2ac47] transition-all duration-500 flex flex-col">
                                    <div className="absolute top-0 left-0 bg-[#d2ac47] text-black text-[9px] font-bold px-3 py-1 uppercase tracking-[0.2em] z-20">
                                        Vision Prompt
                                    </div>
                                    <textarea
                            ...
                            <div className="border-t border-[#d2ac47]/10 pt-4 flex flex-col md:flex-row items-center justify-between gap-4">
                                ...
                                <div
                                    ...
                                    className="cursor-pointer group flex items-center border border-[#d2ac47] w-fit transition-all hover:scale-105 shadow-[0_0_15px_rgba(210,172,71,0.1)] bg-black"
                                >
                                    <div className={`px-6 py-3 text-xs font-bold uppercase tracking-[0.25em] transition-all flex items-center gap-3 ${safeMode ? 'bg-[#d2ac47] text-black shadow-[0_0_20px_rgba(210,172,71,0.5)]' : 'text-[#d2ac47]/30 bg-black hover:text-[#d2ac47]/70'}`}>
                                        <ShieldCheck size={16} strokeWidth={2.5} /> SAFE
                                    </div>
                                    <div className="w-[1px] h-full bg-[#d2ac47]/30"></div>
                                    <div className={`px-6 py-3 text-xs font-bold uppercase tracking-[0.25em] transition-all flex items-center gap-3 ${!safeMode ? 'bg-gradient-to-r from-red-900 to-red-800 text-white shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]' : 'text-[#d2ac47]/30 bg-black hover:text-red-900/70'}`}>
                                ...
                                {loading && (
                                    <button
                                        ...
                                        className="h-full px-6 py-3 border border-red-900/50 bg-red-950/20 text-red-500 hover:bg-red-950/40 hover:text-red-400 hover:border-red-500 transition-all text-xs font-bold uppercase tracking-[0.2em] flex items-center gap-2 group/cancel"
                                    >
                                        <XCircle size={16} className="group-hover/cancel:scale-110 transition-transform" /> CANCEL
                                    </button>
                                )}
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="btn-gold flex-1 md:flex-none py-3 px-8 text-[10px] tracking-[0.3em] flex items-center justify-center gap-3 min-w-[200px] group"
                                >
                                    {loading ? (
                            ...
                            <div className="mt-4 flex-1 bg-[#0a0a0a] border-art-deco p-2 shadow-2xl relative group w-full aspect-square xl:min-h-[600px] flex flex-col">
                                <div className="absolute inset-0 w-full h-full bg-[#050505] flex items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#1a1a1a] to-[#050505]">
                                    {/* Art Deco Corners - Strict Luxury (Moved in as requested) */}
                                    <div className="absolute top-8 left-2 w-4 h-4 border-t border-l border-[#d2ac47] pointer-events-none z-10"></div>
                                    <div className="absolute top-8 right-2 w-4 h-4 border-t border-r border-[#d2ac47] pointer-events-none z-10"></div>
                                    <div className="absolute bottom-8 left-2 w-4 h-4 border-b border-l border-[#d2ac47] pointer-events-none z-10"></div>
                                    <div className="absolute bottom-8 right-2 w-4 h-4 border-b border-r border-[#d2ac47] pointer-events-none z-10"></div>
                                    ...
                                    {loading ? (
                                        ...
                                        <div className="relative w-full h-full">
                                            ...
                                            <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-black to-transparent flex justify-between items-end opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                                <div>
                                                    <p className="text-[#d2ac47] font-serif italic text-xl">Masterpiece Ready</p>
                                                </div>
                                                <button onClick={handleDownload} className="flex items-center gap-2 bg-[#d2ac47] text-black px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-white transition-colors shadow-[0_0_15px_rgba(210,172,71,0.4)]">
                            ...
                            <div className="mt-6 border border-[#d2ac47]/30 bg-[#050505] p-6 relative overflow-hidden group">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {/* Extend Button */}
                                    <button className="flex flex-col items-center justify-center p-4 border border-[#d2ac47]/20 hover:border-[#d2ac47] bg-[#0a0a0a] transition-all group/btn hover:-translate-y-1">
                ...
                <div className="lg:col-span-12 xl:col-span-3 flex flex-col gap-4">
                    ...
                    <div className="bg-[#050505] border-art-deco p-4 flex flex-col items-center justify-center shadow-lg relative overflow-hidden group">
                        ...
                        <button className="mt-2 px-3 py-1 border border-[#d2ac47]/30 text-[#d2ac47] text-[7px] uppercase tracking-[0.2em] hover:bg-[#d2ac47] hover:text-black transition-all">
                            Add Funds
                        </button>
                    </div>
                    ...
                    <div className="flex-1 bg-[#0a0a0a] border-art-deco p-4 shadow-2xl relative min-h-[300px] flex flex-col">
